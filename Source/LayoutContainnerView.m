...
#import "constant.h"
@interface LayoutContainnerView()
...
@implementation LayoutContainnerView
...
-(void)update:(NSMutableArray *)sortedArray{
    ...
    if(sortedArray.count > 4 ){
        ...
        lastView = vie;
        i = 4;
        for (int j = sortedArray.count - 4; j< sortedArray.count; j++) {
    ...
    _headImageView.image =[UIImage imageNamed:@"covernewscell_editor_default.png"];
    ...
    [_likeButton setBackgroundImage:[UIImage imageNamed:@"duanzi_up"] forState:UIControlStateNormal];
